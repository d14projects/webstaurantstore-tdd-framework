...
public class HomePage extends HeaderPage {
    ...
    @FindBy(xpath = "//div[@id='best_selling']//button[@data-control='next']")
    private WebElement bestSellingNextButton;
    @FindBy(xpath = "//div[@id='best_selling']//button[@data-control='prev']")
    private WebElement bestSellingPrevButton;
    public void clickOnButtons(WebElement butn) {
        butn.click();
